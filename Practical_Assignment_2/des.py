...
class des(_baseDes):
    ...
    def __des_crypt(self, block, crypt_type):
        ...
        while i < 16:
            ...
            # L[i] becomes R[i - 1]
            self.L = tempR
            self.intermediate_cyphers.append(self.L+self.R)
...
def perform_experiment(change_plain_text,change_key,change_hamming_distance,experiment_name):
    ...
    for i in range(1,6):
        ...
        # Perform DES to generate orignal cypher
        key=generate_random_string(8)
        plainText=generate_random_string(8)
        d = des(key= bytes(key, 'ascii'))
        ...
        d= des(key= bytes(perturbedKey,'ascii'))
        ...
        hd = [hamming_distance(str1,str2) for str1,str2 in zip(original_intermediate_cyphers,perturbed_intermediate_cyphers)]
        HD.append(hd)
...
if __name__=="__main__":
    ...
    # Part 1 -- for five different plain texts and their purturbation
    ...
    # Part 2 -- five different Hamming distances between plain texts
    ...
    # Part 3 -- for five different keys and their purturbation
